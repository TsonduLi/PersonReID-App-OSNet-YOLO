...
def get_default_config():
    ...
    cfg.model.load_weights = '/home/jiayangwang110/deep-person-reid/log/osnet_x1_0_market1501_softmax_cosinelr/model/model.pth.tar-250' # path to model weights
    ...
    cfg.train.fixbase_epoch = 15 # number of epochs to fix base layers
